...
<body>
    ...
    <script>
        ...
        function buildMarkerHtml(count, name, size) {
            ...
            return '<div style="width:' + size + 'px;height:' + size + 'px;background:#2563eb;color:#fff;border-radius:50%;display:flex;flex-direction:column;align-items:center;justify-content:center;font-weight:bold;box-shadow:0 2px 6px rgba(0,0,0,0.3);line-height:1.2;">' +
