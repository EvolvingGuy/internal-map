...
import com.datahub.geo_poc.es.service.lnbtpu23.Lnbtpu23AggregationService
...
/**
 * LNBTPU23 (Land Nested Building Trade Point Uniform 2-Index 3-Shard) Aggregation 컨트롤러
 * 2개 파티션 인덱스 동시 조회 (lnbtpu23_*) - 균등분배
 */
@RestController
@RequestMapping("/api/es/lnbtpu23/agg")
class Lnbtpu23AggRestController(
    private val aggService: Lnbtpu23AggregationService
) {
    @GetMapping("/sd")
    fun aggregateSd(
