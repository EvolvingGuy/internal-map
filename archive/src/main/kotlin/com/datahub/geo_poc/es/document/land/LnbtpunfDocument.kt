...
/**
 * LNBTPUNF (Land Nested Building Trade Point Uniform No Forcemerge) ES 문서
 * LNBTPU와 동일한 구조, 4개 파티션 인덱스로 균등 분할 (PNU hash % 4), forcemerge 미적용
 */
data class LnbtpunfDocument(
    val pnu: String,
    val sd: String,
    val sgg: String,
    val emd: String,
    ...
    companion object {
        const val INDEX_PREFIX = "lnbtpunf"
