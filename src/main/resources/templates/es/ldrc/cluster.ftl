...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #nav a.active { background: #ea580c; color: white; }
    </style>
</head>
<body>
    <div id="map"></div>
    ...
    <script>
        ...
        function buildLabelHtml(name, count) {
            return '<div style="position:relative;"><div style="background:#ea580c;color:#fff;min-width:60px;padding:8px 12px;border-radius:20px;font-size:11px;font-weight:bold;text-align:center;transform:translate(-50%,-50%);box-shadow:0 2px 6px rgba(0,0,0,0.3);">' +
