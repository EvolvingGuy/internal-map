...
<head>
    ...
    <title>H3 Redis - 읍면동 집계 (res 9)</title>
...
<body>
    ...
    <script>
        ...
        function buildLabelHtml(count, regionName) {
            return '<div style="position:relative;"><div style="background:#7c3aed;color:#fff;padding:4px 8px;border-radius:8px;font-size:11px;font-weight:bold;white-space:nowrap;transform:translate(-50%,-50%);text-align:center;">' +
