...
import com.sanghoon.jvm_jst.es.dto.LcAggRegion
import com.sanghoon.jvm_jst.es.dto.LcAggRequest
import com.sanghoon.jvm_jst.es.dto.LcAggResponse
                        ...
                        bool.must { must ->
                            must.geoBoundingBox { geo ->
                                geo.field("land.center")
                                    .boundingBox { bb ->
                                        bb.tlbr { tlbr ->
                                            tlbr.topLeft { tl -> tl.latlon { ll -> ll.lat(request.neLat).lon(request.swLng) } }
