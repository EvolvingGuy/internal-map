...
/**
 * LBT_17x2_REGION_FM (Land Building Trade, 17인덱스 x 2샤드, SD code 기반, Forcemerge) ES 문서
 */
data class Lbt17x2regionFmDocument(
    val pnu: String,
    val sd: String,
    val sgg: String,
    val emd: String,
    ...
    companion object {
        const val INDEX_PREFIX = "lbt_17x2_region_fm"
