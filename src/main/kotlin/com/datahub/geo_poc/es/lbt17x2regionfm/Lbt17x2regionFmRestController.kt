...
/**
 * LBT_17x2_REGION_FM 관리 컨트롤러 (forcemerge 포함)
 */
@RestController
@RequestMapping("/api/es/lbt-17x2-region-fm")
class Lbt17x2regionFmRestController(
    private val indexingService: Lbt17x2regionFmIndexingService
) {
    @PutMapping("/reindex")
