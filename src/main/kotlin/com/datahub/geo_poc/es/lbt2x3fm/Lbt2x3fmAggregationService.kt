...
/**
 * LBT_2x3_FM Aggregation 서비스
 * 와일드카드 패턴으로 2개 인덱스 동시 조회
 */
@Service
class Lbt2x3fmAggregationService(
    ...
    companion object {
        val INDEX_PATTERN = Lbt2x3fmDocument.allIndexPattern()
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LBT_2x3_FM Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
