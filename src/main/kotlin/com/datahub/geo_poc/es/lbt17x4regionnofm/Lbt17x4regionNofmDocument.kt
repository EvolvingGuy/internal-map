...
/**
 * LBT_17x4_REGION_NOFM (Land Building Trade, 17인덱스 x 4샤드, SD code 기반, No Forcemerge) ES 문서
 */
data class Lbt17x4regionNofmDocument(
    val pnu: String,
    val sd: String,
    val sgg: String,
    val emd: String,
    ...
    companion object {
        const val INDEX_PREFIX = "lbt_17x4_region_nofm"
