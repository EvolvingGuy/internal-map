...
/**
 * LNBTP16 (Land Nested Building Trade Point 16-Shard) Aggregation 서비스
 * 단일 인덱스 16샤드 조회
 */
@Service
class Lnbtp16AggregationService(
    ...
    companion object {
        val INDEX_NAME = Lnbtp16Document.INDEX_NAME
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LNBTP16 Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
            field, regions.size, totalCount, filter.hasAnyFilter(), INDEX_NAME, elapsed)
