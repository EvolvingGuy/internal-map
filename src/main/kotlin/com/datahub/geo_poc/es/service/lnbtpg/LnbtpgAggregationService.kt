...
/**
 * LNBTPG Aggregation 서비스
 * LNBTP와 동일한 집계 로직 (geometryBinary는 집계에 영향 없음)
 */
@Service
class LnbtpgAggregationService(
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LNBTPG Agg] field={}, regions={}, totalCount={}, hasFilter={}, elapsed={}ms",
