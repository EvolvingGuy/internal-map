...
/**
 * LNBT Grid Aggregation 서비스
 * nested 타입 buildings, trades 배열에 대한 필터링 지원
 */
@Service
class LnbtGridAggregationService(
    ...
    fun aggregate(bbox: BBoxRequest, gridParams: GridParamsRequest, filter: LcAggFilter = LcAggFilter()): LcGridAggResponse {
        ...
        log.info("[LNBT Grid] cols={}, rows={}, cellLng={}, cellLat={}", cols, rows, cellLng, cellLat)
        ...
        logProfile(response)
        log.info("[LNBT Grid] cols={}, rows={}, cells={}, totalCount={}, hasFilter={}, elapsed={}ms",
        ...
        shards.forEachIndexed { idx, shardProfile ->
            shardProfile.searches().forEach { search ->
                search.query().forEach { queryProfile ->
                    ...
                    log.info("[LNBT Grid Profile] 샤드[{}] {} - {}ms", idx, queryProfile.type(), timeMs)
                }
            }
        }
    }
