...
/**
 * LNBTPS (Land Nested Building Trade Point SD) Aggregation 서비스
 * 17개 시도별 인덱스 동시 쿼리 (lnbtps_*)
 */
@Service
class LnbtpsAggregationService(
    ...
    companion object {
        val INDEX_PATTERN = LnbtpsDocument.indexPattern()
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LNBTPS Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
