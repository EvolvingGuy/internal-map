...
/**
 * LBT_17x2_REGION_NOFM Aggregation 서비스
 * 와일드카드 패턴으로 17개 인덱스 동시 조회
 */
@Service
class Lbt17x2regionNofmAggregationService(
    ...
    companion object {
        val INDEX_PATTERN = Lbt17x2regionNofmDocument.allIndexPattern()
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LBT_17x2_REGION_NOFM Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
