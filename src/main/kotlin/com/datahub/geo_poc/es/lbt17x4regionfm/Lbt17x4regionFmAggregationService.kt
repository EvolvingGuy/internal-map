...
/**
 * LBT_17x4_REGION_FM Aggregation 서비스
 * 와일드카드 패턴으로 17개 인덱스 동시 조회
 */
@Service
class Lbt17x4regionFmAggregationService(
    ...
    companion object {
        val INDEX_PATTERN = Lbt17x4regionFmDocument.allIndexPattern()
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LBT_17x4_REGION_FM Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
