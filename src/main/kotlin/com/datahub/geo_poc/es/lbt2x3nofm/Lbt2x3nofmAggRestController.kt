...
/**
 * LBT_2x3_NOFM Aggregation 컨트롤러
 */
@RestController
@RequestMapping("/api/es/lbt-2x3-nofm/agg")
class Lbt2x3nofmAggRestController(
    private val aggService: Lbt2x3nofmAggregationService
) {
    @GetMapping("/sd")
    fun aggregateSd(
