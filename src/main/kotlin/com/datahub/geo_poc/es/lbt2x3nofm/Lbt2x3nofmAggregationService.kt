...
/**
 * LBT_2x3_NOFM Aggregation 서비스
 * 와일드카드 패턴으로 2개 인덱스 동시 조회
 */
@Service
class Lbt2x3nofmAggregationService(
    ...
    companion object {
        val INDEX_PATTERN = Lbt2x3nofmDocument.allIndexPattern()
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LBT_2x3_NOFM Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
