...
/**
 * LBT_1x16_FM Aggregation 서비스
 * LSRC 폴백 없음 (항상 ES 쿼리)
 */
@Service
class Lbt1x16fmAggregationService(
    ...
    companion object {
        val INDEX_NAME = Lbt1x16fmDocument.INDEX_NAME
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LBT_1x16_FM Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
