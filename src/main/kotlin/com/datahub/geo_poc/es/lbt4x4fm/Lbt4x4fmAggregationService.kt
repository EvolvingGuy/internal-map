...
/**
 * LBT_4x4_FM Aggregation 서비스
 * 와일드카드 패턴으로 4개 인덱스 동시 조회
 */
@Service
class Lbt4x4fmAggregationService(
    ...
    companion object {
        val INDEX_PATTERN = Lbt4x4fmDocument.allIndexPattern()
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LBT_4x4_FM Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
