...
/**
 * LBT_4x4_NOFM Aggregation 서비스
 * 와일드카드 패턴으로 4개 인덱스 동시 조회
 */
@Service
class Lbt4x4nofmAggregationService(
    ...
    companion object {
        val INDEX_PATTERN = Lbt4x4nofmDocument.allIndexPattern()
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LBT_4x4_NOFM Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
