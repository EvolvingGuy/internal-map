...
/**
 * LBT_1x16_NOFM Aggregation 컨트롤러
 */
@RestController
@RequestMapping("/api/es/lbt-1x16-nofm/agg")
class Lbt1x16nofmAggRestController(
    private val aggService: Lbt1x16nofmAggregationService
) {
    @GetMapping("/sd")
    fun aggregateSd(
