...
/**
 * LBT_1x16_NOFM Aggregation 서비스
 * LSRC 폴백 없음 (항상 ES 쿼리)
 */
@Service
class Lbt1x16nofmAggregationService(
    ...
    companion object {
        val INDEX_NAME = Lbt1x16nofmDocument.INDEX_NAME
    ...
    private fun aggregate(field: String, size: Int, bbox: BBoxRequest, filter: LcAggFilter): LcAggResponse {
        ...
        log.info("[LBT_1x16_NOFM Agg] field={}, regions={}, totalCount={}, hasFilter={}, index={}, elapsed={}ms",
