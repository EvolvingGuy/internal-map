...
import com.datahub.geo_poc.es.service.lnbtps.LnbtpsAggregationService
...
/**
 * LNBTPS (Land Nested Building Trade Point SD) Aggregation 컨트롤러
 * 17개 시도별 인덱스 동시 조회 (lnbtps_*)
 */
@RestController
@RequestMapping("/api/es/lnbtps/agg")
class LnbtpsAggRestController(
    private val aggService: LnbtpsAggregationService
) {
    @GetMapping("/sd")
    fun aggregateSd(
