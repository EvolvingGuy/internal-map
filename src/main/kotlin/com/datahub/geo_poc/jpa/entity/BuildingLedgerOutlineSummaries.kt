...
@Entity
@Table(name = "building_ledger_outline_summaries", schema = "external_data")
data class BuildingLedgerOutlineSummaries(
    @Id
    ...
    @Column(name = "new_regstr_gb_cd")
    val newRegstrGbCd: String? = null,

    @Column(name = "new_regstr_gb_cd_nm")
    val newRegstrGbCdNm: String? = null,
    ...
    @Column(name = "main_bld_cnt")
    val mainBldCnt: String? = null,
    ...
    @Column(name = "tot_pkng_cnt")
    val totPkngCnt: String? = null,
